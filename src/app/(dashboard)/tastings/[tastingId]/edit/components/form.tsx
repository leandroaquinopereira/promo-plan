...
export function EditTastingForm({ tasting }: EditTastingFormProps) {
  ...
  async function handleRegisterTasting({
    ...
    try {
      ...
      if (resultError) {
        toast.error('Erro ao editar tentação', {
      ...
      if (!result.success) {
        let message = 'Erro ao editar tentação'
      ...
      toast.success('Tentação editada com sucesso')
