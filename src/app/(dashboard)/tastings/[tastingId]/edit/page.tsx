...
import { EditTastingForm } from './components/form'
  ...
  try {
    ...
    return (
      <div className="container mx-auto max-w-2xl py-8">
        <div className="mb-8">
          <h1 className="text-2xl font-bold">Editar Degustação</h1>
          <p className="text-muted-foreground">
            Preencha os dados abaixo para editar a degustação.
          </p>
        </div>

        <EditTastingForm tasting={tasting} />
      </div>
    )
  } catch (error) {
