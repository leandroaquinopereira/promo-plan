...
interface ListPaginationSectionProps {
  ...
  totalTastingsShowing?: number
  itemsPerPage?: number
}

export function ListPaginationSection({
  totalTastings = 0,
  totalTastingsShowing = 0,
  ...
  const totalPages = Math.ceil(totalTastings / itemsPerPage)
  ...
  return (
    <CardFooter className="flex items-center justify-between p-0 border-t flex-wrap gap-4">
      <div className="text-sm text-muted-foreground">
        Mostrando {totalTastingsShowing} de {totalTastings} degustações
      </div>
