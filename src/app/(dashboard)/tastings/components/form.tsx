...
type RegisterTastingFormProps = {
  onSubmit?: () => void
}

export function RegisterTastingForm({ onSubmit }: RegisterTastingFormProps) {
    ...
    <div className="space-y-4">
      <Form {...form}>
        <form
          ...
          className="space-y-4 @container max-h-[calc(100dvh-30rem)] overflow-y-auto"
        >
          <FormField
      ...
      <Button
        onClick={() => {
          ...
          handleRegisterTasting(form.getValues())
        }}
        type="submit"
        className="w-full"
