...
export function ListTableRow({
  ...
  function handleViewTasting() {
    router.push(`/tastings/${tasting.id}/detail`)
  }
        ...
        <DropdownMenu open={isDropdownOpen} onOpenChange={setIsDropdownOpen}>
          ...
          <DropdownMenuContent align="end">
            ...
            {tasting.status ===
              (TastingStatusEnum.IN_PROGRESS as TastingStatus) && (
              <Fragment>
                <DropdownMenuItem onClick={handlePauseTasting}>
                  <Pause className="size-4 mr-2" />
                  Pausar degustação
                </DropdownMenuItem>
                <DropdownMenuItem onClick={handleStopTasting}>
                  <StopIcon className="size-4 mr-2" />
                  Parar degustação
                </DropdownMenuItem>
                <DropdownMenuItem onClick={handleFinishTasting}>
